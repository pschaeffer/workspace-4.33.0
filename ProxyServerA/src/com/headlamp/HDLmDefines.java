...
public class HDLmDefines {	
  ...
  private static final Logger LOG = LoggerFactory.getLogger(HDLmDefines.class);  
	...
	private static final Map<String, String> defines = Map.ofEntries(		  
		...
		Map.entry("HDLMAPICHECKUSERNAMEPASSWORDUPDATEMEMORY",  "checkUsernamePasswordUpdateMemory"),
	  ...
	  Map.entry("HDLMDATABASEDOMAINNAME",                    "HDLm_Database_Domain_Name"),	
	  Map.entry("HDLMDATABASEUSERID",                        "HDLm_Database_Userid"),
    ...
    Map.entry("HDLMDIVISIONNODEPATHINDEX",                 "4"),
    ...
    Map.entry("HDLMDIVISIONTYPE",                          "division"),
	  ...
	  Map.entry("HDLMHOSTNAMENODEPATHLENGTH",                "3"),	
	  ...
	  Map.entry("HDLMIGNORELISTSTYPE",                       "lists"),
	  ...
	  Map.entry("HDLMREPORTSTYPE",                           "reports"),
	  Map.entry("HDLMRHINOSYNTAXERROR",                      "SyntaxError"),
    ...
    Map.entry("HDLMSETLASTTIME",                           "setLastTime"),
	  ...
	  Map.entry("HDLMSITENODEPATHINDEX",                     "5"),

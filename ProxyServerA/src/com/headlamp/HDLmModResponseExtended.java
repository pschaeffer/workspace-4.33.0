...
/**
 * HDLmModResponseExtended short summary.
 *
 * HDLmModResponseExtended description.
 *
 * @version 1.0
 * @author Peter
 */
...
public class HDLmModResponseExtended {
	/* The next statement initializes logging to some degree. Note that 
     having the slf4j jars and the log4j jars in the classpath also
     plays some role in logging initialization. */
  private static final Logger LOG = LoggerFactory.getLogger(HDLmModResponseExtended.class); 
	/* This is the standard constructor for this class. At present
     it does not do anything. */
  public HDLmModResponseExtended() {}	
  ...
  protected static HDLmModResponseExtended  getStandardFields(JsonElement jsonElement,
  	...
  	/* Try to build a response object that can be returned to
  	   the caller */ 
  	HDLmModResponseExtended  response = new HDLmModResponseExtended();
  	if (response == null) {
  ...
  /* Get the value of the use mode field and return it to the caller */

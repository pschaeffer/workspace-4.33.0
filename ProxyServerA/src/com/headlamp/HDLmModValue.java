...
/**
 * HDLmModValue short summary.
 *
 * HDLmModValue description.
 *
 * @version 1.0
 * @author Peter
 */
...
public class HDLmModValue extends HDLmMod {
  ...
  protected HDLmModValue() { 
  	...
  	associatedNodeType = HDLmTreeTypes.VALUE;
	...
	protected HDLmModValue(final JsonElement jsonElement) {
		/* Invoke the default constructor for the parent class. This is 
	     required by the Java language. */ 
	  super();
    ...
    HDLmModResponseExtended  response = HDLmModResponseExtended.getStandardFields(jsonElement, 
	  ...
	  if (commentsInfo != null && !StringUtils.isWhitespace(commentsInfo)) {
		...
		/* Mark the current report definition object as not usable,

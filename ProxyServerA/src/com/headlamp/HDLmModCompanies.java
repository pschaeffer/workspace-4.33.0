...
/**
 * HDLmModCompanies short summary.
 *
 * HDLmModCompanies description.
 *
 * @version 1.0
 * @author Peter
 */
...
public class HDLmModCompanies extends HDLmMod {
  ...
  protected HDLmModCompanies() { 
  	...
  	countCompanies = 0;
  	companiesTreeMap = new TreeMap<String, HDLmModCompany>();
  }
	...
	protected HDLmModCompanies(final JsonElement jsonElement) {
	  ...
	  MutableInt   errorCounter = new MutableInt(0);
		...
		if (errorMessages == null) {
			String  errorText = "Error message ArrayList allocation in HDLmModCompanies constructor is null";
			throw new NullPointerException(errorText);
		}	
    ...
    countCompanies = 0; 
		/* Mark the current companies definition object as not executable,
  ...
  TreeMap<String, HDLmModCompany>  companiesTreeMap = null;
  ...
  /* This routine get the list (actually a tree map) of companies
     ...
     caller */ 
  protected TreeMap<String, HDLmModCompany>  getCompaniesTreeMap() {

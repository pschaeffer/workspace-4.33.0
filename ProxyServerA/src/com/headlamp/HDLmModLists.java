...
/**
 * HDLmModLists short summary.
 *
 * HDLmModLists description.
 *
 * @version 1.0
 * @author Peter
 */
...
public class HDLmModLists extends HDLmMod {
  ...
  protected HDLmModLists() { 
    ...
    super();
  	...
  	countLists = 0;
  	ignoreLists = new TreeMap<String, HDLmModList>();
  	if (ignoreLists == null)
	...
	protected HDLmModLists(final JsonElement jsonElement) {
	  ...
	  MutableInt   errorCounter = new MutableInt(0);
		...
		if (errorMessages == null) {
			String  errorText = "Error message ArrayList allocation in HDLmModLists constructor is null";
			throw new NullPointerException(errorText);
		}
    ...
    countLists = 0; 
		/* Mark the current lists (set of ignore-lists) definition object as 
		   not executable, if the error count was greater than zero. This is 
  ...
  private TreeMap<String, HDLmModList>  ignoreLists = null;  
  ...
  protected TreeMap<String, HDLmModList>  getIgnoreLists() {
    return ignoreLists;
  } 
